...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_details', function (Blueprint $table) {
            ...
            $table->decimal('less_quantity_kg',10,2)->default(0);
            $table->decimal('actual_quantity',10,2)->default(0);
            $table->decimal('rate_kg',10,2)->default(0);
            $table->decimal('amount',10,2)->default(0);
            $table->decimal('purchase_commission',10,2)->default(0);
            $table->decimal('transport_cost',10,2)->default(0);
            $table->decimal('unloading_cost',10,2)->default(0);
            $table->decimal('sale_income_per_bag',10,2)->default(0);
