...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('purchase_details', function (Blueprint $table) {
            ...
            $table->decimal('quantity_bag',14,2)->default(0);
            $table->decimal('quantity_kg',14,2)->default(0);
            $table->decimal('discount',14,2)->default(0)->nullable();
            $table->decimal('less_quantity_kg',14,2)->default(0);
            $table->decimal('actual_quantity',14,2)->default(0);
            $table->decimal('rate_kg',14,2)->default(0);
            $table->decimal('amount',14,2)->default(0);
            $table->decimal('purchase_commission',14,2)->default(0);
            $table->decimal('transport_cost',14,2)->default(0);
            $table->decimal('unloading_cost',14,2)->default(0);
            $table->decimal('sale_income_per_bag',14,2)->default(0);
