...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('regular_purchase_return_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_id')->index()->foreign()->references('id')->on('companies')->onDelete('cascade');
            $table->unsignedBigInteger('purchase_return_id')->nullable()->index()->foreign()->references('id')->on('regular_purchase_returns')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('regular_purchase_return_details');
    }
};
