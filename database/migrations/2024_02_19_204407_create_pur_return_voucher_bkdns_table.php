...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pur_return_voucher_bkdns', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_id')->index()->foreign()->references('id')->on('companies')->onDelete('cascade');
            $table->unsignedBigInteger('purchase_return_voucher_id');
    ...
    {
        Schema::dropIfExists('pur_return_voucher_bkdns');
    }
};
