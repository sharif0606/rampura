...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('beparian_purchase_return_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('company_id')->index()->foreign()->references('id')->on('companies')->onDelete('cascade');
            $table->unsignedBigInteger('purchase_return_id')->nullable()->index()->foreign()->references('id')->on('beparian_purchase_returns')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('beparian_purchase_return_details');
    }
};
