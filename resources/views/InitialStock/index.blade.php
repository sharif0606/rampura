@extends('layout.app')
@section('pageTitle',trans('Initial Stock List'))
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row pb-1">
                                    ...
                                    <div class="col-7">
                                        <div class="d-flex">
                                            ...
                                            <div class="input-group-append" style="margin-left: -2px;">
                                                <a class="btn btn-warning ms-2" href="{{route(currentUser().'.initialStock.index')}}" title="Clear"><i class="bi bi-arrow-clockwise"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-2">
                        <a class=" float-end" href="{{route(currentUser().'.initialStock.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                    </div>
                </div>
                <!-- table bordered -->
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    @if(currentUser() == 'admin' || currentUser() == 'owner')
                                        <a href="{{route(currentUser().'.initialStock.edit',encryptor('encrypt',$pur->id))}}">
