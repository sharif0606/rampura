                                        ...
                                        <tbody>
                                            @forelse ($childTow as $ex)
                                                ...
                                                @if($ex->head_code == 5322)
                                                    <tr class="tbl_expense">
                                                        <th class="tbl_expense" style="padding-left: 8px;">{{$ex->head_name}} <input type="hidden" name="child_two_id[]" value="{{$ex->id}}"></th>
                                                        <td class="tbl_expense" ><input type="text" onkeyup="total_expense(this)" class="form-control expense_value text-end ltr_interest" name="cost_amount[]" value="@if(isset($expense[$ex->id])){{$expense[$ex->id]}} @endif" readonly></td>
                                                    </tr>
                                                @endif
                                            @empty
