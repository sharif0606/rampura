                        ...
                        <table style="width: 100%">
                            <tr style="text-align: center;">
                                <th colspan="2">
                                    ...
                                    <h6 style="padding-bottom: 3.5rem;">PURCHASES INVOICE</h6>
                                </th>
                            </tr>
                        </table>
                        <table style="width: 100%;">
                            ...
                            <table class="tbl_expense" style="width:100%">
                                <tbody>
                                    ...
                                    <tr class="tbl_expense">
                                        ...
                                        <td class="tbl_expense" style="text-align: center; padding: 5px;">{{$formattedAmount = number_format((round($s->rate_kg)), 0, '.', ',');}}</td>
                                        <td class="tbl_expense" style="text-align: center; padding: 5px;">{{$formattedAmount = number_format((round($s->amount)), 0, '.', ',');}}</td>
                                    </tr>
                                    @php
