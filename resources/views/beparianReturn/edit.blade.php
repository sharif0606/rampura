                                ...
                                <div class="col-md-4">
                                    <select class="form-control choices form-select" name="supplierName" id="supplierName" onchange="get_purchase()">
                                        ...
                                        @forelse($suppliers as $d)
                                            <option class="brnch brnch{{$d->branch_id}}" value="{{$d->id}}" {{ old('supplierName',$return->supplier_id)==$d->id?"selected":""}}>{{ $d->supplier_name}}-({{ $d->upazila?->name}})</option>
                                        @empty
                                    ...
                                    <table class="table mb-5">
                                        ...
                                        <tbody id="details_data">
                                            ...
                                            <tr class="productlist text-center">
                                                <td class="py-2 px-1">{{$p->productName}}
                                                ...
                                                <td class="py-2 px-1"><input type="text" name="lot_no[]" value="{{$p->lot_no}}" class="form-control lot_no" required></td>
                                                <td class="py-2 px-1"><input type="text" name="brand[]" value="{{$p->brand}}" class="form-control brand"></td>
                                                <td class="py-2 px-1"><input type="text" value="{{$p->bag_qty+$p->quantity_bag}}" class="form-control stock_bag" disabled></td>
                                                <td class="py-2 px-1"><input type="text" value="{{$p->qty+$p->quantity_kg}}" class="form-control" disabled></td>
                                        ...
                                        <tfoot>
                                            <tr class="bg-warning">
                                                ...
                                                <th class="py-2 px-1 total_return_amount">{{$amountTotal}}</th>
                                                <th class="py-2 px-1"></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                        ...
                                        <tfoot>
                                            <tr class="tbl_expense">
                                                ...
                                                <td class="tbl_expense text-end" >
                                                    <h5 class="tgrandtotal" style=" padding-right: 10px;">{{$return->grand_total}}</h5>
                                ...
                                <div class="col-4 mt-2 text-start">
                                    <label for="" class="form-group">
                                        ...
                                        if($actualQtyTotal != 0){
                                            ...
                                            $pricePerKg = $return->grand_total / $actualQtyTotal;
