...
@section('pageTitle',trans('Beparian Return'))
    ...
    <div class="match-height">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" action="{{route(currentUser().'.beparianReturn.store')}}">
                        @csrf
                        <div class="row">
...
$(function() {
    ...
    $("#item_search").autocomplete({
        source: function(data, cb){
            ...
            $.ajax({
                autoFocus:true,
                url: "{{route(currentUser().'.pur.product_search_beparian_return')}}",
                method: 'GET',
                dataType: 'json',
                data: {
...
function return_row_with_data(item_id){
    ...
    $.ajax({
        autoFocus:true,
        url: "{{route(currentUser().'.pur.product_sc_d_beparian_return')}}",
        method: 'GET',
        dataType: 'json',
        data: {
