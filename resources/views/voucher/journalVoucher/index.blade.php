                                ...
                                <div class="input-group input-group-sm d-flex justify-content-between" >
                                    <div class="d-flex" style="width: 150px;">
                                        ...
                                        <div class="input-group-append" style="margin-left: -2px;">
                                            <a class="btn btn-warning ms-2" href="{{route(currentUser().'.journal.index')}}" title="Clear"><i class="bi bi-arrow-clockwise"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    ...
                                    @if(currentUser() == 'admin' || currentUser() == 'owner')
                                        ...
                                        <form id="form{{$cr->id}}" onsubmit="return confirm('Are you sure to delete this record?')" action="{{route(currentUser().'.journal.destroy',encryptor('encrypt',$cr->id))}}" method="post">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    @endif
