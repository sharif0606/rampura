...
@section('pageTitle',trans('Show Credit/Receive Voucher'))
                                ...
                                <table style="width: 100%" id="companyDescript">
                                    <tr style="text-align: center;">
                                        <th colspan="2">
                                            ...
                                            <h3 style="padding-bottom: 2rem;">Receive Voucher</h3>
                                        </th>
                                    </tr>
                                </table>
                            </div>
                            {{-- <h1 class="d-none only_print text-center mb-3">Receive Voucher</h1> --}}
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="countryName">{{__('Voucher No')}}: </label> <span>{{$creditVoucher->voucher_no}}</span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="countryName">{{__('Date')}}: </label> <span>{{$creditVoucher->current_date}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="payment">{{__('Received Account')}}: 
                                            @if($crevoucherbkdn)
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group @if($errors->has('name')) has-error @endif">
                                            <label>{{__('Cheque No')}}: </label>{{$creditVoucher->cheque_no}}
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                        <label>{{__('Bank Name')}}: </label>{{$creditVoucher->bank}}
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                        <label>{{__('Cheque Date')}}: </label>{{$creditVoucher->cheque_dt}}
                                        </div>
                                    </div>
                                </div>
