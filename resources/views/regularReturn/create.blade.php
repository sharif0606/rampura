...
@section('pageTitle',trans('Regular Return'))
    ...
    <div class="match-height">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form class="form" method="post" action="{{route(currentUser().'.regularReturn.store')}}">
                        @csrf
                        <div class="row">
...
$(function() {
    ...
    $("#item_search").autocomplete({
        source: function(data, cb){
            ...
            $.ajax({
                autoFocus:true,
                url: "{{route(currentUser().'.pur.product_search_regular_return')}}",
                method: 'GET',
                dataType: 'json',
                data: {
