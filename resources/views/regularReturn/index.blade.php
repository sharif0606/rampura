@extends('layout.app')
@section('pageTitle',trans('Regular Return List'))
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="row pb-1">
                                    ...
                                    <div class="col-8">
                                        <div class="d-flex">
                                            ...
                                            <div class="input-group-append" style="margin-left: -2px;">
                                                <a class="btn btn-warning ms-2" href="{{route(currentUser().'.regularReturn.index')}}" title="Clear"><i class="bi bi-arrow-clockwise"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-2">
                        <a class=" float-end" href="{{route(currentUser().'.regularReturn.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                    </div>
                </div>
                <!-- table bordered -->
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    ...
                                    @if(currentUser() == 'admin' || currentUser() == 'owner')
                                        <a href="{{route(currentUser().'.regularReturn.edit',encryptor('encrypt',$pur->id))}}">
