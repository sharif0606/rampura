@extends('layout.app')
@section('pageTitle',trans('Beparian Purchase List'))
    ...
    <div class="row" id="table-bordered">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                {{-- <div>
                    <a class="float-end" href="{{route(currentUser().'.bpurchase.create')}}"style="font-size:1.7rem"><i class="bi bi-plus-square-fill"></i></a>
                </div> --}}
                <div class="row pb-1">
                    <div class="col-10">
                                    ...
                                    <div class="col-8">
                                        <div class="d-flex">
                                            ...
                                            <div class="input-group-append" style="margin-left: -2px;">
                                                <a class="btn btn-warning ms-2" href="{{route(currentUser().'.bpurchase.index')}}" title="Clear"><i class="bi bi-arrow-clockwise"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="white-space-nowrap">
                                    <a href="{{route(currentUser().'.bpurchase.show',encryptor('encrypt',$pur->id))}}">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>&nbsp;
                                    @if(currentUser() == 'admin' || currentUser() == 'owner')
                                        <a href="{{route(currentUser().'.bpurchase.edit',encryptor('encrypt',$pur->id))}}">
