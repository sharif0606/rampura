        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="text-center no_print"><h4>DAY/ YERALY SALES STATEMENT  (report)</h4></div>
                    <div class="card-body">
                            ...
                            <table  style="width: 100%; margin-bottom: 2rem;">
                                <tr style="text-align: center;">
                                    <th colspan="2">
                                        ...
                                        <h6><span style="border-bottom: solid 1px;">Sales Report</span></h6>
                                    </th>
                                </tr>
                            </table>
                        </div>
                            ...
                            <div class="row no_print">
                                ...
                                <div class="col-md-4 mt-4">
                                    <select class="form-control form-select" name="customer" id="customer">
                                        ...
                                        @foreach($customers->where('is_walking', 1) as $c)
                                            <option value="{{$c->id}}" {{ isset($_GET['customer']) && $_GET['customer'] == $c->id ? 'selected' : '' }}>
                                                {{ $c->customer_name }}
                                            </option>
                                        @endforeach
                                    
                                        @foreach($customers->where('is_walking', 0) as $c)
                                            <option value="{{$c->id}}" {{ isset($_GET['customer']) && $_GET['customer'] == $c->id ? 'selected' : '' }}>
                                                {{ $c->customer_name }}
                                            </option>
                                        @endforeach
                                ...
                                <table class="table mb-5">
                                    <thead>
                                        <tr class="tbl_border  text-center">
                                            ...
                                            <th class="p-2 tbl_border">{{__('Total')}}</th>
                                            <th class="p-2 tbl_border">{{__('Remaining')}}</th>
                                            ...
                                            <th class="p-2 tbl_border">{{__('Broker Commission')}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                        ...
                                        @forelse($d->sale_lot as $sd)
                                            @if(request('lc_no'))
                                                @if(request('lc_no')==$sd->lot_no)
                                                    <tr class="tbl_border text-center">
                                                        <td class="tbl_border"> </td>
                                                        ...
                                                        <td class="tbl_border">
                                                            @php
                                                                ...
                                                                $lotWiseStocktotal = 0;
                                                                if ($product) {
                                                                    $lotWiseStocktotal = App\Models\Stock\Stock::where('product_id', $product->id)
                                                            ...
                                                            @endphp
                                                            ({{ money_format($lotWiseStocktotal) }}) কেজি
                                                        </td>
                                                        <td class="tbl_border">({{ money_format($lotWiseStock) }}) কেজি</td>
                                                        <td class="tbl_border">
                                                            {{money_format($sd->quantity_kg)}} কেজি
                                                        </td>
                                                        <td class="tbl_border">{{money_format($sd->quantity_bag)}} বস্তা</td>
                                                        <td class="tbl_border">{{$sd->amount}}</td>
                                                        <td class="tbl_border"></td>
                                                        <td class="tbl_border"> </td>
                                                        <td class="tbl_border"></td>
                                                        <td class="tbl_border"></td>
