@extends('layout.app')
@section('pageTitle',trans('LC Expense Reports'))
                            ...
                            <table style="width: 100%" id="companyDescript">
                                <tr style="text-align: center;">
                                    <th colspan="2">
                                        ...
                                        <h4 style="padding-bottom: 2.5rem;">LC Expense Reports</h4>
                                    </th>
                                </tr>
                            </table>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="accDate">{{__('LC NO')}}</label>
                                        <input type="text"class="form-control" value="{{isset($_GET['lc_no'])?$_GET['lc_no']:''}}" name="lc_no" id="lc_no" placeholder="Lc number">
                                    </div>
                                </div>
...
<script>
    function printReport(divName) {
        ...
        printContentDiv.innerHTML = '<table style="width: 100%;">' +
                                        '<tr>' +
                                        '<th style="width: 15%;"><label>LC NO:</label></th>' +
                                        '<td style="width: 48%;">' + lc_no + '</td>' +
