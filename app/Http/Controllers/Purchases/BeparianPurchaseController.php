...
class BeparianPurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('beparianPurchase.create',compact('branches','suppliers','Warehouses'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('beparianPurchase.edit',compact('branches','suppliers','Warehouses','purchase','purchaseDetails'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            if($pur->save()){
                ...
                return redirect()->route(currentUser().'.bpurchase.index')->with($this->resMessageHtml(true,null,'Successfully Update'));
            }else
                return redirect()->back()->withInput()->with($this->resMessageHtml(false,'error','Please try again'));
        }catch(Exception $e){
            DB::rollback();
